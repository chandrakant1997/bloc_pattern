...
import 'package:rozarpay_imple/bloc/weather_bloc.dart';
import 'package:rozarpay_imple/model/cordinate_model.dart';
import 'package:rozarpay_imple/model/main_model.dart';
import 'package:rozarpay_imple/model/system_model.dart';
import 'package:rozarpay_imple/model/weather_response_model_class.dart';
import 'package:rozarpay_imple/model/wind_model.dart';
...
class WeatherScreenState extends State<WeatherScreen> {
  ...
  Column _buildSys(Sys sys) {
    ...
    print(dateFormat.format(sunriseDate).toString() + "chandrakant----------");
    var sunsetDate = new DateTime.fromMillisecondsSinceEpoch(sys.sunset * 1000);
    print(dateFormat.format(sunsetDate) + "kusheaha------");
